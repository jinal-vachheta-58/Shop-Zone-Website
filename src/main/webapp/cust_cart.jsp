...
<%
    ...
    try {
        ...
        ps.setInt(1, 1);  // Replace 1 with the actual customer ID
        ...
        <div class="col-lg-8 table-responsive mb-5">
            <table class="table table-light table-borderless table-hover text-center mb-0">
                ...
                <tbody class="align-middle">
                    ...
                    <a href="product_detailed_page.jsp?pro_id=<%=proId%>">
                            
                                <img src="<%=imgPath%>" alt="<%=title%>" style="width: 130px; height:150px"> 
                                <%=title%>
                        ...
                        <td class="align-middle">
                            <div class="input-group quantity mx-auto" style="width: 100px;">
                                <div class="input-group-btn">
                                    <button class="btn btn-sm btn-primary btn-minus" onclick="updateQuantity('<%=proId%>', <%=quantity-1%>)"><i class="fa fa-minus"></i></button>
                                </div>
                                <input type="text" class="form-control form-control-sm bg-secondary border-0 text-center" value="<%=quantity%>" readonly>
                                <div class="input-group-btn">
                                    <button class="btn btn-sm btn-primary btn-plus" onclick="updateQuantity('<%=proId%>', <%=quantity+1%>)"><i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                        </td>
                        <td class="align-middle">$<%=total%></td>
                        <td class="align-middle">
                            <button class="btn btn-sm btn-danger" onclick="removeFromCart('<%=proId%>')">
